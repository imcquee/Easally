...
gameLauncher = InputBox("Enter the path to your game launcher (WITHOUT QUOTES):" + vbNewLine + vbNewLine + "Default Locations:" + vbNewLine + vbNewLine + "Steam: " + "C:\Program Files (x86)\Steam\steam.exe" + vbNewLine + vbNewLine + "Playnite: " + localFolder + vbNewLine + "\Playnite\Playnite.FullscreenApp.exe", "Easally")
